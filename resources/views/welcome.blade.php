...
<head>
    ...
    <script src="https://twemoji.maxcdn.com/2/twemoji.min.js"
        integrity="sha384-vojMYWMgmEhE4UFyXarYAx15WrGwFWfYep8svrRf1anCUzrYn9xlhuXrK9fgsixc" crossorigin="anonymous">
    </script>

</head>

<body class="antialiased">
    <header class="text-gray-600 body-font bg-gray-100 border-b border-gray-300 shadow-lg top-0 sticky w-full z-50">
                ...
                @if (Route::has('login'))
                        @auth
                            <a href="{{ route('contacts.index') }}"
                                class=" text-gray-700 dark:text-gray-500 ">Contactos</a>
                        @else
                            <a href="{{ route('login') }}" class=" text-gray-700 dark:text-gray-500 ">Log in</a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}"
                                    class="ml-4  text-gray-700 dark:text-gray-500 ">Register</a>
                            @endif
                        @endauth
                @endif
            </nav>
    ...
    <div class="">
        ...
        <section class="px-32 text-gray-600 body-font">
            <div class="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
                ...
                <div class="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
                    ...
                    <div class="flex w-full justify-center items-end">
                        ...
                        <button
                            class="inline-flex text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded text-lg">Button</button>
                    </div>
